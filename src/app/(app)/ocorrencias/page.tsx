...
import { canRegisterOcorrencia } from "@/lib/roles";
import OcorrenciasClient from "./ocorrencias-client";

export const dynamic = "force-dynamic";

export default async function OcorrenciasPage() {
  const session = await requireTab("ocorrencias");
  return (
    <div>
      ...
      <OcorrenciasClient podeRegistrar={canRegisterOcorrencia(session.role)} />
    </div>
  );
}
